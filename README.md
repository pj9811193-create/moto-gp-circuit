...
- Pick from **100 bikes** in the garage (20 colors × 5 classes — Street 125 … Legend GP; each has different top speed / acceleration / handling).
...
2. When it's live you get an address like `https://your-app.onsender.com` — everyone just
